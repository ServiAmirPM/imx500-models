...
For each example under the [**reference deep learning models**](https://github.com/ServiAmirPM/imx500-models/edit/main/README.md#reference-deep-learning-models) you will have to run an execution command indicating both model and **application name**.

Available applications are as appears below:
...
|------------------------------------|---------------------------------------|------------------|------------------------------------------------------------------------------------------------------------------------|
| efficientnet_b0                    | **72.128​** (73.876)                   | 224x224          | imx500_classification_demo.py --model /usr/share/imx500-models/imx500_network_efficientnet_bo.rpk                      |
| efficientnet_lite0                 | **75.252** (75.28)                    | 224x224          | imx500_classification_demo.py --model /usr/share/imx500-models/imx500_network_efficientnet_lite0.rpk                   |
| efficientnetv2_b0                  | **76.674​** (76.424)                   | 224x224          | imx500_classification_demo.py --model /usr/share/imx500-models/imx500_network_efficientnetv2_b0.rpk                    |
| efficientnetv2_b1                  | **77.032​** (76.93)                    | 240x240          | imx500_classification_demo.py --model /usr/share/imx500-models/imx500_network_efficientnetv2_b1.rpk                    |
| efficientnetv2_b2                  | **77.716** (77.94)                    | 260x260          | imx500_classification_demo.py --model /usr/share/imx500-models/imx500_network_efficientnetv2_b2.rpk                    |
| levit_128s                         | **62.29​** (58.312)                    | 224x224          | imx500_classification_demo.py --model /usr/share/imx500-models/imx500_network_levit_128s.rpk                           |
| mnasnet1.0                         | **73.16​** (73.078)                    | 224x224          | imx500_classification_demo.py --model /usr/share/imx500-models/imx500_network_mnasnet1.0.rpk                           |
| mobilenet_v2                       | **71.572​** (74.18)                    | 224x224          | imx500_classification_demo.py --model /usr/share/imx500-models/imx500_network_mobilenet_v2.rpk                         |
| mobilevit_xs                       | **72.326​** (72.412)                   | 256x256          | imx500_classification_demo.py --model /usr/share/imx500-models/imx500_network_mobilevit_xs.rpk                         |
| mobilevit_xxs                      | **67.44​0** (67.40)                    | 256x256          | imx500_classification_demo.py --model /usr/share/imx500-models/imx500_network_mobilevit_xxs.rpk                        |
| regnetx_002                        | **68.352​** (68.20)                    | 224x224          | imx500_classification_demo.py --model /usr/share/imx500-models/imx500_network_regnetx_002.rpk                          |
| regnety_002                        | **69.424​** (69.60)                    | 224x224          | imx500_classification_demo.py --model /usr/share/imx500-models/imx500_network_regnety_002.rpk                          |
| regnety_004                        | **73.83​0** (73.37)                    | 224x224          | imx500_classification_demo.py --model /usr/share/imx500-models/imx500_network_regnety_004.rpk                          |
| resnet18                           | **68.57​** (68.546)                    | 224x224          | imx500_classification_demo.py --model /usr/share/imx500-models/imx500_network_resnet18.rpk                             |
| shufflenet_v2_x1_5                 | **72.194​** (72.498)                   | 224x224          | imx500_classification_demo.py --model /usr/share/imx500-models/imx500_network_shufflenet_v2_x1_5.rpk                   |
| squeezenet1.0                      | **57.598** (57.584)                   | 224x224          | imx500_classification_demo.py --model /usr/share/imx500-models/imx500_network_squeezenet1.0.rpk                        |  
...
|------------------------------------|---------------------------------------|------------------|------------------------------------------------------------------------------------------------------------------------|
| efficientdet_lite0_pp              | **0.252** (0.2518)​                    | 320x320          | imx500_object_detection_demo.py --model /usr/share/imx500-models/imx500_network_efficientdet_lite0_pp.rpk              |
| nanodet_plus_416x416               | **0.332**​ (0.3316)                    | 416x416          | imx500_object_detection_demo.py --model /usr/share/imx500-models/imx500_network_nanodet_plus_416x416.rpk               |
| nanodet_plus_416x416_pp            | **0.32​0** ​(0.3232)                    | 416x416          | imx500_object_detection_demo.py --model /usr/share/imx500-models/imx500_network_nanodet_plus_416x416_pp.rpk            |
| ssd_mobilenetv2_fpnlite_320x320_pp | **0.218** (0.219) ​                    | 320x320          | imx500_object_detection_demo.py --model /usr/share/imx500-models/imx500_network_ssd_mobilenetv2_fpnlite_320x320_pp.rpk |
...
|------------------------------------|-----------------------------------------|------------------|------------------------------------------------------------------------------------------------------------------------|
| deeplabv3plus                      | **0.7214​** (0.724) ​                     | 320x320          | imx500_segmentation_demo.py  --model /usr/share/imx500-models/imx500_network_deeplabv3plus.rpk                         |
...
| Model                              | [mAP] Accuracy - Quantized(Float)    | Input Resolution | Picamera2 example script                                                                                               |
|------------------------------------|--------------------------------------|------------------|------------------------------------------------------------------------------------------------------------------------|
| higherhrnet_coco                   | **0.188​** (0.1867)                   | 228x640          | imx500_pose_estimation_higherhrnet_demo.py --model /usr/share/imx500-models/imx500_network_higherhrnet_coco.rpk        |
